...
#
# Usage:
#   osgiFunctionCheckCompilerFlags(FLAGS_TO_CHECK VALID_FLAGS_VAR)
#
# Example:
#
#   set(myflags)
#   osgiFunctionCheckCompilerFlags("-fprofile-arcs" myflags)
#   message(1-myflags:${myflags})
#   osgiFunctionCheckCompilerFlags("-fauto-bugfix" myflags)
#   message(2-myflags:${myflags})
#   osgiFunctionCheckCompilerFlags("-Wall" myflags)
#   message(3-myflags:${myflags})
#
#   The output will be:
...
function(osgiFunctionCheckCompilerFlags CXX_FLAG_TO_TEST RESULT_VAR)
  ...
  # For that same reason, osgiFunctionCheckCompilerFlags function appends a unique suffix to
